...
module SwaggerClient
  ...
  class Package
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'available_from')
        self.available_from = attributes[:'available_from']
      end

      if attributes.has_key?(:'available_until')
      ...
      if attributes.has_key?(:'trips')
        if (value = attributes[:'trips']).is_a?(Array)
          self.trips = value
        end
      end
      ...
      if attributes.has_key?(:'accommodations')
        if (value = attributes[:'accommodations']).is_a?(Array)
    ...
    def hash
      [id, name, description, available_from, available_until, decimal_price, trips, courses, accommodations].hash
    end
