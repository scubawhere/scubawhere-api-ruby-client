...
module SwaggerClient
  class LocationsApi
    ...
    def get_location(id, opts = {})
      data, _status_code, _headers = get_location_with_http_info(id, opts)
      return data
    end
    ...
    def get_location_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LocationsApi.get_location ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling LocationsApi.get_location" if id.nil?
      # resource path
      local_var_path = "/location".sub('{format}','json')
